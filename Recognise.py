...
face_cas = cv2.CascadeClassifier(
    'C:/Users/admin/Downloads/Automatic_attendence_system_using_facial_recognition_python_openCV-main/Automatic_attendence_system_using_facial_recognition_python_openCV-main/haarcascade_frontalface_default.xml')
